...
@interface MOBIMMessageGroupModel : NSObject
...
// 组成员
@property (nonatomic, strong) NSMutableArray<MOBIMMessageUserModel *> *userList;
// 组的未读数
...
@property (nonatomic, copy) NSString *editIntroductionDate;
